...
flags = tf.app.flags
flags.DEFINE_string("save_path", "models/combined", "Directory to write the model and "
                    "training summaries.")
flags.DEFINE_string("train_data", "data/combined_words.txt", "Training text file. "
                    "E.g., unzipped file http://mattmahoney.net/dc/text8.zip.")
flags.DEFINE_string(
    "eval_data", "benchmarks/questions.txt", "File consisting of analogies of four tokens."
